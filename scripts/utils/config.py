...
def parse_args():
    ...
    parser.add("--root_path", default="./dataloaders")
    ...
    parser.add("--eval_rotation", default=rotation_tools.RotationType.ROT_6D.name, type=str)
    ...
    parser.add("--cache_path", default="default_cache", type=str)
    ...
    parser.add("--head_rep", default=None, type=str)
    ...
    parser.add("--pose_file_extension", default="bvh", type=str)
    parser.add("--pose_eval_rep", default="bvh_rot_6d", type=str)
    parser.add("--pose_vis_rep", default="bvh_rot_vis", type=str)
    ...
    parser.add("--pose_dims", default=141, type=int) # 141 = 47 * 3
    parser.add("--joint_nums", default=47, type=int)
    parser.add("--output_joint_dims", default=3, type=int) # Euler Angles
    parser.add("--train_joint_dims", default=6, type=int) # Rot6d
    parser.add("--eval_joint_dims", default=3, type=int)
    ...
    parser.add("--head_norm", default=True, type=str2bool)
    ...
    parser.add("--pre_frames", default=16, type=int)
    parser.add("--stride", default=10, type=int)
    parser.add("--ae_pose_length", default=32, type=int) # For using different ae trainer
    parser.add("--pre_type", default="zero", type=str)
    
    parser.add("--audio_f", default=128, type=int)
    parser.add("--facial_f", default=128, type=int)
    parser.add("--head_rot_f", default=12, type=int) # Added head rotation as new input
...
#    parser.add("--gan_noise_size", default=0, type=int)
    # --------------- metric -------------------------- #
    parser.add("--srgr_threshold", default=0.1, type=float)
    # --------------- device -------------------------- #
